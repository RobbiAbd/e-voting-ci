              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="statistic-details mt-sm-4">
                    <?php foreach ($total_voting as $voting) : ?>
                    <div class="statistic-details-item">
                      <div class="detail-value"><?= $voting['total_voting'] ?></div>
                      <div class="detail-name"><?= $voting['nama'] ?></div>
                    </div>
                  <?php endforeach; ?>
                  </div>
                </div>
...
<?= $this->section('script') ?>
  ...
  <script>
    ...
    var myChart = new Chart(ctx, {
      type: 'bar',
      data: {
        labels: [<?php foreach($total_voting as $voting) echo '"'.$voting['nama'].'",'; ?>],
        datasets: [{
          label: '# Voting',
          data: [<?php foreach($total_voting as $voting) echo $voting['total_voting'].','; ?>],
          backgroundColor: [
          'rgba(255, 99, 132, 0.2)',
          'rgba(54, 162, 235, 0.2)',
          'rgba(255, 206, 86, 0.2)',
