...
<?= $this->section('content') ?>
    ...
    <div class="row">
    	<div class="col-md-8">
    		<div class="row">
    			<div class="col-md-6">
    				<form action="<?= base_url('admin/token/add') ?>" method="POST">
    					<?= csrf_field(); ?>

						<div class="form-group">
				          <label for="token">Token</label>
				          <input type="text" class="form-control" name="token_key" id="token" value="<?= $token ?>" readonly="">
				        </div>

				  		<div class="form-group">
				          <label for="jumlah">Jumlah Max Pengguna (angka)</label>
